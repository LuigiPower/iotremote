 ...
 */
public class ValueChangedAboveEvent extends ValueChangedEvent
{
    private String threshold;

    public ValueChangedAboveEvent()
    {
        this("1");
    }

    public ValueChangedAboveEvent(String valueTo)
    {
    ...
    {
        return R.layout.detail_type_value_changed_above;
    }

    @Override
    public int getEditLayoutResourceId()
    {
        return R.layout.edit_detail_type_value_changed_above;
    }
    ...
    protected void populateView(View view)
    {
        ...
        TextView parameterFrom = (TextView) view.findViewById(R.id.parameter_above);
    ...
    protected void populateEditView(View view)
    {
        ...
        EditText parameterFrom = (EditText) view.findViewById(R.id.parameter_above);
        parameterFrom.setText(threshold);
